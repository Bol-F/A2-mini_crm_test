...
const translations = {
  ru: {
    ...
    pageDescription: "Управляйте воронкой продаж и следующими действиями",
    language: "Язык",
    russian: "Русский",
    english: "English",
    newLead: "Новый лид",
    ...
    newLeads: "Новые",
    qualifiedLeads: "Квалифицированы",
    consultations: "Консультации",
    rejectedLeads: "Отказы",
    specifications: "С запросом ТЗ",
    formDescription: "Добавьте контакт и назначьте ответственного сотрудника.",
    listDescription: "Актуальные лиды, отсортированные от новых к старым.",
    emptyTitle: "Лидов пока нет",
    emptyDescription: "Создайте первый лид — он появится здесь и сохранится после перезапуска.",
    addFirstLead: "Добавить первый лид",
    requiredField: "Обязательное поле",
    formReset: "Форма очищена.",
    stageLabel: "Этап",
  },
  en: {
    appName: "Mini CRM",
    pageTitle: "Lead management",
    pageDescription: "Manage your sales pipeline and next actions",
    language: "Language",
    russian: "Русский",
    english: "English",
    newLead: "New lead",
    ...
    formDescription: "Add a contact and assign a responsible employee.",
    listDescription: "Current leads sorted from newest to oldest.",
    emptyTitle: "No leads yet",
    emptyDescription: "Create the first lead. It will appear here and persist after restart.",
    addFirstLead: "Add first lead",
    requiredField: "Required field",
    formReset: "Form cleared.",
    stageLabel: "Stage",
  },
} as const;
